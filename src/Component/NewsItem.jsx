...
function NewsItem({ title, description, urlToImage, content, url }) {
  return (
    ...
    <div className=" border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center flex-wrap ">
            <a href={url} target= "_blank" rel="noopener" className=" bg-zinc-900 inline-flex items-center md:mb-2 lg:mb-0 mx-auto text-white border-0 py-1 px-2 focus:outline-none hover:bg-zinc-700 rounded text-sm">Learn More
